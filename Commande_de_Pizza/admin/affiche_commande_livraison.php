...
-->
 <!DOCTYPE html>
<html>
<title>Commnades en livraison</title>
 <?php
...
<h1> <p style="text-align:center">Les Commandes En Livraison<h1/> <tr/>
...
{
    echo"<tr class='success' style = 'text-align : center;'><td> $donnees[ref] </td><td>$donnees[date]</td> <td>$donnees[statut]</td><td><a href= 'terminee.php?cid=$donnees[cid]'>Terminer</a></td> </tr>";
}
echo "</table>";
}
echo "<br><br><br><br><br>
