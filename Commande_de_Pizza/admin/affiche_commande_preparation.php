...
-->
 <!DOCTYPE html>
 <title>Commnades en Préparation</title>
<html>
 <?php
...
<h1> <p style="text-align:center">Les Commandes en Préparation<h1/> <tr/>
...
{
    echo"<tr class='success' style = 'text-align : center;'><td> $donnees[ref] </td><td>$donnees[date]</td> <td>$donnees[statut]</td><td><a href= 'livraison.php?cid=$donnees[cid]'>Livrer</a></td> </tr>";
}
echo "</table>";
}
